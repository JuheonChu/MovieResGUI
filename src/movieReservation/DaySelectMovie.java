...
public class DaySelectMovie extends JFrame {
   ...
   public DaySelectMovie(String id, String pw, String name, String selectTitle) {
	  this.id=  id;
	  this.pw = pw;
	  this.name = name;
      this.selectTitle = selectTitle;
      System.out.println("============");
      System.out.println("날짜 선택창입니다.");
...
//       grayLabel.setPreferredSize(new Dimension(350, 30));
      ...
      for (int i = 0; i < days.length - 1; i++) {
         ...
         if (Integer.parseInt(days[i].getText()) >= 21 && Integer.parseInt(days[i].getText()) <= 23) { // 20,21,22일만
                                                                                 // 날짜 선택
                                                                                 // 가능하게 함
            ...
            days[i].addActionListener(new ActionListener() {
               ...
               public void actionPerformed(ActionEvent e) {
                  ...
                  new TheatherSelect(id,pw,name, getSelectTitle(), day2).setVisible(true);
                  dispose();
               }
            });
         }
